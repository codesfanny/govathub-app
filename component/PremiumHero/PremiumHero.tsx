...
const PremiumHero = () => {
  return (
    <div className="w-full flex flex-col h-screen lg:justify-center bg-blue-950 bg-blend-multiply bg-[url(/images/premium-bg-01.jpg)] bg-center bg-cover transition-all duration-300">
      <div className="w-[80%] flex items-end justify-center space-x-16 transition-all duration-300">
        ...
        >
          ...
          <h1 className="mt-20 lg:mt-0 text-5xl lg:text-6xl font-semibold leading-16 lg:leading-18 text-white z-200">
            Premium <br /> Accelerated <br /> Mentoring <br /> Experience
          </h1>
        </div>
        <div className="">
          <button className="hidden lg:block text-white bg-transparent font-bold border-2 border-white hover:bg-[#1b48c0] hover:border-[#1b48c0] hover:text-white py-3 px-12 transition-all duration-500 cursor-pointer">
            CHAT WITH AN EXPERT
          </button>
        </div>
      </div>
